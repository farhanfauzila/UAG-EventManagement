                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                <input type="password" name="password" id="password" class="form-control"
                                    style="border-right:none;" required pattern="(?=.*[A-Za-z])(?=.*\d).{6,}">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="input-group">
                                <input type="password" name="confirm_password" id="confirm_password"
                                    class="form-control" style="border-right:none;" required>
                                <span class="input-group-text" onclick="togglePassword('confirm_password')">
                                    <i class="bi bi-eye" id="icon-confirm_password"></i>
                                </span>
                            </div>
                            <small id="passwordHelp" class="text-danger d-none fw-bold"
                                style="font-size: 0.7rem;">Password tidak cocok!</small>
                        </div>
                    </div>
